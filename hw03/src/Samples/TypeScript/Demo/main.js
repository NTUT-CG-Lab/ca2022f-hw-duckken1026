...
const regularSelector = document.getElementById('regularSelect');
const specifySelector = document.getElementById('specifySelect');
const regularParamName = document.getElementById('regularParamName');
const specifyParamName = document.getElementById('specifyParamName');
const regularSlider = document.getElementById('regularSlider');
const specifySlider = document.getElementById('specifySlider');
const regularMin = document.getElementById('regularMin');
const regularMax = document.getElementById('regularMax');
const specifyMin = document.getElementById('specifyMin');
const specifyMax = document.getElementById('specifyMax');
